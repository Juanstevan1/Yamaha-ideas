...
urlpatterns = [
    ...
    path('coordinator/review/', views.coordinator_review_ideas, name='coordinator_review_ideas'),
    path('coordinator/review/<int:idea_id>/', views.coordinator_review_idea, name='coordinator_review_idea'),
    path('committee/review/', views.committee_review_ideas, name='committee_review_ideas'),
    path('committee/review/<int:idea_id>/', views.committee_review_idea, name='committee_review_idea'),
    path('coordinator/assign_team/', views.coordinator_assign_team, name='coordinator_assign_team'),
    path('coordinator/assign_team/<int:idea_id>/', views.coordinator_assign_team_detail, name='coordinator_assign_team_detail'),
